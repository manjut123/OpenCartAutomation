...
test.describe.serial('running e2e go rest crud api tests', () => {
    ...
    //GET test:
    test('GET API -- get all users @sanity', async ({ apiHelper }) => {
    ...
    test('POST API -- create a user @sanity', async ({ apiHelper }) => {
        let userData = {
            name: 'Naveen API',
    ...
    test('PUT API -- Update a user @sanity', async ({ apiHelper }) => {
        let userUpdatedData = {
    ...
    test('DELETE API -- Delete a user @sanity', async ({ apiHelper }) => {
